...
Overall, this app combines **predictive analytics** with **interactive visualization** to support business decision-making.
""")
...
if st.sidebar.button("Predict Purchase"):
    try:
        ...
        ax2.plot(range(1, len(costs) + 1), costs, color="purple", linewidth=2, label="Training Cost")
        ax2.fill_between(range(1, len(costs) + 1), costs, color="purple", alpha=0.2)
